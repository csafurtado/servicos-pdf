...
def abre_janela_slice(j_principal, fonte_arq_pdf):   
    ...
    label_qtd_paginas_pdf = Label(janela_base, text=f"Quantidade de páginas: {manipuladorPDF.qtd_paginas}", fg="white", bg=cor_fundo_janela, font=('Helvetica 10 bold'))
    ...
    botao_executar_slice = Button(janela_base, background="#cf5f5f", text="Cortar", width=10, height=3, command= lambda: manipuladorPDF.faz_slice_paginas_pdf(campo_lim_inferior.get(), campo_lim_superior.get()))
